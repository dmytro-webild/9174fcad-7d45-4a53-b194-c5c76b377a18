    ...
    >
      ...
      <div id="testimonials" data-section="testimonials">
        <TestimonialCardTwo
          ...
          testimonials={[
            {
              id: "t1",              name: "DevastatedAlex",              role: "Teammate - 47 Games Lost",              testimonial: "I've seen things in those matches that I can't unsee. The spray control into the wall while enemies push. The flash grenade that blinded me during a 1v1. I'll be in therapy forever. 10/10 experience.",              imageSrc: "http://img.b2bpic.net/free-photo/mad-man-throwing-pillow-frustration-cursing-own-team-getting-defeated_482257-119916.jpg?_wi=1",              imageAlt: "DevastatedAlex frustrated expression"
            },
            {
              id: "t2",              name: "ConfusedMartin",              role: "Teammate - Still Processing",              testimonial: "I genuinely cannot understand the physics of missing a shot from 2 meters away. Is he using an invisible weapon? Does his mouse have negative sensitivity? I have so many questions and no answers.",              imageSrc: "http://img.b2bpic.net/free-photo/young-beautiful-couple-boy-girl-wearing-casual-clothes-having-fun-smiling-sticking-out-tongues-showing-ok-sign-light_141793-58888.jpg?_wi=1",              imageAlt: "ConfusedMartin bewildered expression"
            },
            {
